...
describe('page3-pagamento date calculation', () => {
    ...
    test('Tiradentes holiday (Tuesday Apr 21) shifts to next Wednesday', () => {
        const tiradentes = new Date(2026, 3, 21); // Tuesday, national holiday
